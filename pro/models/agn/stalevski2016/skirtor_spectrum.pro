function skirtor_spectrum, skirtor, tau97=tau97, i_agn=i_agn, tauV_diff=tauV_diff, $
                           delta=delta, atten_curve=atten_curve, uv_bump=uv_bump, $
                           error_check=error_check, xray_isotropic=xray_isotropic, $
                           Lnu_spec_unred_AGN=Lnu_spec_unred_AGN, Lbol_abs_AGN=Lbol_abs_AGN, $
...
; Generate model Lnu
 ...
 Nwave = n_elements(skirtor.WAVE_OBS)
 ...
 ; Attenuate the AGN emission
 Lnu_spec_AGN = exp_neg_tau * Lnu_spec
 Lnu_spec_unred_AGN = Lnu_spec
