...
; If /EXP or /POW recast trapezoidal rule into Lin-Log or Log-Log space,
; by calling Trapex or Trapow respectively.
; HISTORY:
; Written: Frank Varosi, HSTX @ NASA/GSFC, 1988-1995.
; MODIFICATION: Rafael Eufrasio, Truncation value changed from 1.e-37 to 1.d-200, Feb 18 2020
;-
...
;Perform the integration:
  ...
  CASE Log_axes OF
      ...
      return, Trapow( f > 1d-200, x, VEC=vector, DEL=delta )
    END

       1: BEGIN
      return, Trapex( f > 1d-200, x, VEC=vector, DEL=delta )
    END
