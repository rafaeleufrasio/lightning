...
for f=0,(Nfilters-1) do begin
  if read_filters then begin
    case filter_labels[f] of
      ...
      'WFI_U':              trans_curve = filters_dir+'WFI/U38.txt'
      'WFI_B':              trans_curve = filters_dir+'WFI/B99.txt'
      'WFI_V':              trans_curve = filters_dir+'WFI/V89.txt'
      'WFI_Rc':             trans_curve = filters_dir+'WFI/Rc162.txt'
      'WFI_Ic':             trans_curve = filters_dir+'WFI/Ic.txt'
      'CTIO_U':             trans_curve = filters_dir+'CTIO/CTIO_U.txt'
      'VIMOS_U':            trans_curve = filters_dir+'VIMOS/VIMOS_U.txt'
      'VIMOS_B':            trans_curve = filters_dir+'VIMOS/VIMOS_B.txt'
      'VIMOS_V':            trans_curve = filters_dir+'VIMOS/VIMOS_V.txt'
      'VIMOS_R':            trans_curve = filters_dir+'VIMOS/VIMOS_R.txt'
      'VIMOS_I':            trans_curve = filters_dir+'VIMOS/VIMOS_I.txt'
      'VIMOS_Z':            trans_curve = filters_dir+'VIMOS/VIMOS_Z.txt'
      ...
      'MegaPrime_ustar':    trans_curve = filters_dir+'CFHT/MegaPrime/MegaPrime_ustar.txt'
      'MegaPrime_gprime':   trans_curve = filters_dir+'CFHT/MegaPrime/MegaPrime_gprime.txt'
      'MegaPrime_rprime':   trans_curve = filters_dir+'CFHT/MegaPrime/MegaPrime_rprime.txt'
      'MegaPrime_iprime':   trans_curve = filters_dir+'CFHT/MegaPrime/MegaPrime_iprime.txt'
      'MegaPrime_zprime':   trans_curve = filters_dir+'CFHT/MegaPrime/MegaPrime_zprime.txt'
      'WIRCam_CH4':         trans_curve = filters_dir+'CFHT/WIRCam/CH4.txt'
      'WIRCam_H':           trans_curve = filters_dir+'CFHT/WIRCam/H.txt'
      'WIRCam_H2':          trans_curve = filters_dir+'CFHT/WIRCam/H2.txt'
      'WIRCam_J':           trans_curve = filters_dir+'CFHT/WIRCam/J.txt'
      'WIRCam_Ks':          trans_curve = filters_dir+'CFHT/WIRCam/Ks.txt'
      'WIRCam_Y':           trans_curve = filters_dir+'CFHT/WIRCam/Y.txt'
      'LBCB_U':             trans_curve = filters_dir+'LBT/LBC/LBCB_Bessel-U.txt'
      'LBCB_B':             trans_curve = filters_dir+'LBT/LBC/LBCB_Bessel-B.txt'
      'LBCB_V':             trans_curve = filters_dir+'LBT/LBC/LBCB_Bessel-V.txt'
      'LBCR_V':             trans_curve = filters_dir+'LBT/LBC/LBCR_Bessel-V.txt'
      'LBCR_R':             trans_curve = filters_dir+'LBT/LBC/LBCR_Bessel-R.txt'
      'LBCR_I':             trans_curve = filters_dir+'LBT/LBC/LBCR_Bessel-I.txt'
      ...
      'SUBARU_iprime':      trans_curve = filters_dir+'SUBARU/SUBARU_iprime.txt'
      ...
      'ISAAC_J':            trans_curve = filters_dir+'ISAAC/ISAAC_J.txt'
      'ISAAC_H':            trans_curve = filters_dir+'ISAAC/ISAAC_H.txt'
      ...
      'IRS_PB':             trans_curve = filters_dir+'SPITZER/IRS/bluePUtrans.txt'
      'IRS_PR':             trans_curve = filters_dir+'SPITZER/IRS/redPUtrans.txt'
