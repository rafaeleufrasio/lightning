...
; Core options to Lightning
          ...
          OUTPUT_FILENAME: 'J033226_xray_output'     ,$
...
; Dust attenuation module options
          ...
          ;============== CALZETTI_MOD PARAMETERS =========================
              ...
              DELTA:     {Prior: 'uniform'                          ,$
                          Prior_arg: [-10.d, 10.d]                  ,$
                          Initialization_range: [-1.0d, 1.0d]        $
                          }                                         ,$
...
; X-ray emission module options
          ...
          NH:          {Prior: 'uniform'                            ,$
                        ...
                        Initialization_range: [1.d0, 1.d2]          $
                        }                                           ,$
          ...
          ;================= QSOSED PARAMETERS =========================================
              ...
              AGN_MASS:    {Prior: 'uniform'                        ,$
                            ...
                            Initialization_range: [1.d6, 1.d8]       $
                            }                                       ,$
...
; AGN emission module options
          ...
          ;================= SKIRTOR PARAMETERS ==================================
              ...
              LOG_L_AGN: {Prior: 'uniform'                          ,$
                          ...
                          Initialization_range: [10.d, 12.d]          $
                          }                                         ,$
