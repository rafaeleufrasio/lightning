...
; Core options to Lightning
          ...
          OUTPUT_FILENAME: 'doore_with_xrays'     ,$
...
; Dust attenuation module options
          ...
          ;================  DOORE21 PARAMETERS =============================
              ...
              TAUB_F:    {Prior: 'uniform'                          ,$
                          Prior_arg: [0.0d, 8.0d]                   ,$
                          Initialization_range: [0.0d, 4.0d]         $
                          }                                         ,$
              ...
              COSI:      {Prior: 'tabulated'                               ,$
                          Prior_arg: [!lightning_dir+'examples/NGC_4631/'] ,$
                          Initialization_range: [0.005d, 0.2d]              $
                          }                                                ,$
              ...
              B_TO_D:    {Prior: 'fixed'                            ,$
                          Prior_arg: [0.0d]                         ,$
                          Initialization_range: [0.0d, 0.d0]         $
                          }                                         ,$
...
; Dust emission module options
          ...
          ;============== DL07 PARAMETERS ===================================
              ...
              GAMMA:   {Prior: 'uniform'                            ,$
                        Prior_arg: [0.0d, 1.0d]                     ,$
                        Initialization_range: [0.0d, 0.1d]           $
                        }                                           ,$
